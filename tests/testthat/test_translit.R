...
test_that("Time steps are translated", {
  ts_raw <- c(
    "10lepte", "30lepte", "5lepte", "Etesia", "Emeresia", "Meniaia",
    "Oriaia"
  )

  tr_trans <- c(
    "10_minutes", "30_minutes", "5_minutes", "annual", "daily",
    "monthly", "hourly"
  )
...
test_that("Water Divisions are translated", {
  wd_raw <- c(
    "ANATOLIKE MAKEDONIA ", "ANATOLIKE PELOPONNES",
  ...
  wd_trans <- c(
    "GR11", "GR03", "GR07", "GR06", "GR02", "GR09", "GR01", "GR04",
